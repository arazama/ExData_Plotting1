...
par(mfrow=c(2,2))
Plot1 <- plot(sub4$Datetime, sub4$Global_active_power, type="l",xlab="", ylab="Global Active Power (Kilowatts)")
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty=1, lwd=2.5, cex=0.2,col=c("black", "red", "blue"))
